...
port 22 --script=ssh2-enum-algos.nse SSH #
port 23 --script=telnet-ntlm-info.nse Telnet
port 25 --script=smtp-enum-users.nse SMTP #
port 53 --script=dns-brute.nse DNS
port 80 --script=http-enum.nse,http-wordpress-enum.nse,http-backup-finder HTTP
port 110 --script=pop3-ntlm-info.nse,pop3-capabilities.nse POP3 #
port 111 --script=nfs-ls,nfs-statfs,nfs-showmount NFS
port 143 --script=imap-ntlm-info.nse,imap-capabilities.nse IMAP #
port 443 --script=http-enum.nse,http-wordpress-enum.nse,http-backup-finder HTTPS #
port 445 --script=smb-enum-shares.nse,smb-enum-users.nse SMB
port 465 --script=smtp-enum-users.nse SMTPS #
port 993 --script=imap-ntlm-info.nse,imap-capabilities.nse IMAPS #
port 995 --script=pop3-ntlm-info.nse,pop3-capabilities.nse POP3S #
